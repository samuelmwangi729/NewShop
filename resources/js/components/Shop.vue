            ...
            <div class="col-sm-8 offset-sm-2 card">
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <input type="file" name="Logo"  class="form-control" style="border:none" required>
                    </div>
                        ...
                        <input type="file" name="Pin"  class="form-control" style="border:none" required>
                    </div>
                        ...
                        <select v-model="County"  class="form-control" required name="County">
                        ...
                        <label for="Name" class="label-control">
                         ...
                         <select v-model="CountyTown"  class="form-control" required name="Town">
                        ...
                        <label for="Name" class="label-control">
                         ...
                         Phone Number
                         <input type="number" name="ShopPhoneNumber" id="" class="form-control" required maxlength="10" minlength="10">
                        </label>
                    </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select name="Acceptable" id="" class="form-control" v-model="Acceptable" required>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="MpesaNumber" class="form-control" placeholder="For Mpesa Payments" required>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <input type="number" class="form-control" placeholder="Bank Account to Receive Payment," maxlength="20" minlength="10" name="ShopBankAccount">
                            </div>
                        </div>
                    </div>
