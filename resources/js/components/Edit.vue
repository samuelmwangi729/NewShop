<template>
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-10 offset-sm-1 card">
          ...
          <form :action="'/product/'+Edited.Slug" method="POST" enctype="multipart/form-data">
          <input type="text" name="_token" id="" class="hidden" :value="token">
          <input type="text" name="_method" id="" class="hidden" value="PATCH">
            <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <input type="text" name="ProductName" class="form-control" :value="Edited.ProductName" />
                </div>
              </div>
              <!-- End col-sm-6 -->
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <select name="Brand" class="form-control">
                    ...
                    <option :value="Edited.ProductBrand" selected>{{ Edited.ProductBrand }}</option>
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <select name="Category"  class="form-control" @change="Load()" v-model="Category">
                            ...
                            <option :value="Edited.ProductCategory">{{Edited.ProductCategory}}</option>
                    ...
                    <div class="form-group">
                        <label for="Image1" class="label-control">
                         ...
                         <select name="SubCategory"  class="form-control">
                            ...
                            <option :value="Edited.ProductSubCategory" selected>{{Edited.ProductSubCategory}}</option>
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        ...
                        <input type="number" name="Qty" id="" class="form-control" :value="Edited.Qty">
                    </div>
                </div>
                <div class="col-sm-3 text-center">
                   <label for="" class="label-control">
                    ...
                    <br><input type="checkbox" name="O" checked>
                </div>
                <div class="col-sm-12">
                        <textarea name="Description" id="demo-summernote" style="width:100%" v-html="Edited.Description"></textarea>
                </div>
            </div>
  ...
  <script>
      export default{
          ...
          methods:{
              getEdited(){
                  axios.get('/bxn/VoLkOGYUjbGeiCyfSsBmghDBl').then((response)=>{
                      this.Edited=response.data
                      this.Price=this.Edited.Price
                      this.Category=this.Edited.ProductCategory
                      this.Discount=this.Edited.Discount
                      this.SKU=this.Edited.SKU
                  })
              },
              Load(){
